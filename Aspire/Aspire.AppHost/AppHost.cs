...
var apiGW = builder.AddProject<Projects.Service_ApiGateway>("api-gw", project => { project.ExcludeLaunchProfile = true; })
...
builder.AddProject<Projects.Service_ApiGateway>("serive-apigateway");

builder.AddProject<Projects.Service_ApiGateway>("service-apigateway");
