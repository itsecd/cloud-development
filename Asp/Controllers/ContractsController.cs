...
public class ContractsController : ControllerBase
{
    ...
    public async Task<ActionResult<VehicleContractDto>> GenerateVehicle([FromQuery] int? seed = null)
    {
       ...
       "Получен запрос на генерацию vehicle contract. Ip: {IpAddress}, SeedFromQuery: {SeedFromQuery}, ActualSeed: {ActualSeed}",
       ip,
       seed,
       actualSeed);
        ...
        _logger.LogInformation(
        "Запрос успешно обработан. Ip: {IpAddress}, Manufacturer: {Manufacturer}, Model: {Model}, Year: {Year}",
        ip,
