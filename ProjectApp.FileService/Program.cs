...
builder.Services.AddSingleton<ICreditApplicationQueueConsumer, SqsCreditApplicationQueueConsumer>();
builder.Services.AddSingleton<ICreditApplicationObjectStorage, MinioCreditApplicationObjectStorage>();
